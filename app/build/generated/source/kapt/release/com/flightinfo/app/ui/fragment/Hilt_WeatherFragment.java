 ...
 */
public abstract class Hilt_WeatherFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_WeatherFragment() {
    super();
  }

  Hilt_WeatherFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WeatherFragment_GeneratedInjector) this.generatedComponent()).injectWeatherFragment(UnsafeCasts.<WeatherFragment>unsafeCast(this));
    }
  }

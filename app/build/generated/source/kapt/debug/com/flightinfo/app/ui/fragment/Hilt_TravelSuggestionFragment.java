 ...
 */
public abstract class Hilt_TravelSuggestionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_TravelSuggestionFragment() {
    super();
  }

  Hilt_TravelSuggestionFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TravelSuggestionFragment_GeneratedInjector) this.generatedComponent()).injectTravelSuggestionFragment(UnsafeCasts.<TravelSuggestionFragment>unsafeCast(this));
    }
  }

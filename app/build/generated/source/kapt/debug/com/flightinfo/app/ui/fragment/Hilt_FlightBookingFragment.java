 ...
 */
public abstract class Hilt_FlightBookingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FlightBookingFragment() {
    super();
  }

  Hilt_FlightBookingFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FlightBookingFragment_GeneratedInjector) this.generatedComponent()).injectFlightBookingFragment(UnsafeCasts.<FlightBookingFragment>unsafeCast(this));
    }
  }

...
### 👤 用户个人中心 (新功能)
- **统一管理**: 提供统一的界面来管理用户个人信息、偏好设置等。
- **收藏与历史**: 查看收藏的航班和历史搜索记录。

### 🌳 碳足迹计算 (新功能)
- **环保评估**: 根据飞行距离和机型估算每次飞行的碳排放量。
- **影响评级**: 提供高、中、低三档碳排放影响评级，引导用户选择更环保的航班。
...
### 功能增强
- **[已完成] 用户个人中心**: 提供统一的界面来管理用户个人信息、偏好设置等。
- **[已完成] 碳足迹计算**: 根据飞行距离和机型估算每次飞行的碳排放量。
- **[已完成] 航线地图**: 可视化航班路线。
- **航班预订集成**：与航空公司预订系统对接
- **推送通知**：航班状态变化实时通知
- **收藏功能**：用户可收藏常用航班

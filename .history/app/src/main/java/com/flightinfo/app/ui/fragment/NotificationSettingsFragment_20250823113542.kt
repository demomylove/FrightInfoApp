...
class NotificationSettingsFragment : Fragment() {
    ...
    private fun setupPreferenceListeners() {
        binding.delayNotificationsSwitch.setOnCheckedChangeListener { _: SwitchMaterial, isChecked: Boolean ->
            // Save preference
            savePreference("delay_notifications", isChecked)
        }
        
        binding.cancellationNotificationsSwitch.setOnCheckedChangeListener { _: SwitchMaterial, isChecked: Boolean ->
            // Save preference
            savePreference("cancellation_notifications", isChecked)
        }
        
        binding.gateChangeNotificationsSwitch.setOnCheckedChangeListener { _: SwitchMaterial, isChecked: Boolean ->
            // Save preference
            savePreference("gate_change_notifications", isChecked)
        }
        
        binding.doNotDisturbSwitch.setOnCheckedChangeListener { _: SwitchMaterial, isChecked: Boolean ->
